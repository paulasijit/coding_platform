        ...
        <form method="post" action="#" >
          ...
          <div class="form-group">
            ...
            <select id="gender" name="gender" class="form-control">
                ...
                <option value="dontshare">DON'T SHARE</option>
              </select>
            </div>
          <div class="form-group">
            <label>Age</label>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="workplace" style="width:20em;" required placeholder="Company/Institute"></textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input type="submit" name="submit" class="btn btn-primary submitBtn" style="width:20em; margin:0;" /><br><br>
             <center>
             <p class="impact"><a href="index.php">LogIn</a></p>
           </center>
          </div>
        </form>
      </div>
...
if($r==0){
$sql="INSERT INTO rating (username) VALUES('".$user."')";
mysqli_query($db,$sql) or die ('Error in updating Database');

  $query = "INSERT INTO users
                (username, password, full_name, gender,age,country, workplace)
                VALUES ('".$user."','".$pass."','".$fname."','".$gender."','".$age."','".$country."', '".$workplace."')";
                mysqli_query($db,$query)or die ('Error in updating Database');
                ?>
                <script type="text/javascript">
            alert("Successfull Account Created!");
