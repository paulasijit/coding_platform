...
?>
    ...
    <h1><small>Submit Solution</small></h1>
      ...
      ?>
      <form method="post" action="ceval.php">
      <?php if($num == 0)
      ...
      <br/><br>
      <p style="color:red;"><b>PLEASE ADD FILE EXTENSION IN FILENAME(.py,.rb,.cpp,.c,.java)!!!!!!!!!</b></p>
      ...
      <textarea style="font-family: mono; height:400px;" class="span9" row="200" col="400" name="soln" id="editor"><?php if(!($num == 0)) echo($fields['soln']);?></textarea><br/>
