    ...
    <div class="container">
      ...
      <div>
        <div>
          ...
          Problem Title: <input style="width:700px;" type="text" id="pname" name="pname" value="<?php echo($selected['name']);?>"/><br/>
          Contest Name: <input style="width:700px;" type="text" id="title" name="title" value="<?php echo($selected['cname']);?>" readonly/><br/>
          <div class="controls">
            <div class="input-append">
              ...
              Points: <input class="span2" id="points" size="8" type="text" name="points" value="<?php echo($selected['points']); ?>"><span class="add-on">+</span>
              penalty: <input class="span2" id="penalty" size="8" type="text" name="penalty" value="<?php echo($selected['penalty']); ?>"><span class="add-on">-</span>
            </div>
          </div>
          <br/>
          ...
          Contest Name: <input style="width:700px;" type="text" id="cname" name="cname"/><br/>
          <div class="controls">
            <div class="input-append">
              Time Limit: <input class="span2" id="appendedInput" size="8" type="text" name="time"><span class="add-on">ms</span>
              Points: <input class="span2" id="points" size="8" type="text" name="points"><span class="add-on">+</span>
              penalty: <input class="span2" id="penalty" size="8" type="text" name="penalty"><span class="add-on">-</span>
            </div>
          </div>
          <br/>
          Detailed problem: <span class="label label-info">Markdown formatting supported</span></br/><br/>
